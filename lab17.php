...
while($row = $records->fetch_assoc()){
  echo "<tr><td>".$row["id"]."</td><td>".$row["name"]."</td><td>".$row["phone"]."</td><td><a href='viewrecord.php?sid=".$row['id']." '>VIEW</a>,
   <a href='editrecord.php?sid=".$row['id']." '>EDIT</a>,
   <a href='deleterecord.php?sid=".$row['id']." '>DELETE</a></td></tr>";
}
echo "</table>";
} else{
